...
if ( !defined( 'CARL500_TEMPLATE_PATH' ) )
	define( 'CARL500_TEMPLATE_PATH', 'D:/Program Files/wamp/www/carl500/template/' );

// Define the fucntion path
if ( !defined( 'CARL500_FUNCTIONS_PATH' ) )
	define( 'CARL500_FUNCTIONS_PATH', 'D:/Program Files/wamp/www/carl500/functions/' );

// Define the template path
if ( !defined( 'CARL500_CLASSES_PATH' ) )
	define( 'CARL500_CLASSES_PATH', 'D:/Program Files/wamp/www/carl500/classes/' );
