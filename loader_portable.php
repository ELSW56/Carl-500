...
if ( !defined( 'CARL500_TEMPLATE_PATH' ) )
	define( 'CARL500_TEMPLATE_PATH', 'C:/wamp/www/carl500_new_v1/template/' );

// Define the fucntion path
if ( !defined( 'CARL500_FUNCTIONS_PATH' ) )
	define( 'CARL500_FUNCTIONS_PATH', 'C:/wamp/www/carl500_new_v1/functions/' );

// Define the template path
if ( !defined( 'CARL500_CLASSES_PATH' ) )
	define( 'CARL500_CLASSES_PATH', 'C:/wamp/www/carl500_new_v1/classes/' );

	// Define the style path
if ( !defined( 'CARL500_STYLE_PATH' ) )
	define( 'CARL500_STYLE_PATH', 'C:/wamp/www/carl500_new_v1/style/' );
